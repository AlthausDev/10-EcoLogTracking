...
using EcoConsoleBackService.Models;
        ...
        public async void SendEmail()
        {
            try
            {
                ...
                if (!listaLogs.IsNullOrEmpty())
                {
                    ...
                    sw.WriteLine("No se ha registrado ningún error el "+ DateTime.Now.AddDays(-1).ToString("dddd, dd/MM/yyyy"));
                }
